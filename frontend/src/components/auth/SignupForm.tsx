              ...
              <TabsContent value="vendor">
                <form onSubmit={handleVendorSignup} className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="vendor-owner-name" className="text-gray-900 dark:text-white flex items-center gap-2 text-base font-semibold">
                        <UserCircleIcon className="w-4 h-4 text-green-600" strokeWidth={2} />
                        Owner Name *
                      </Label>
                      <input
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="vendor-phone" className="text-gray-900 dark:text-white flex items-center gap-2 text-base font-semibold">
                        <PhoneIcon className="w-4 h-4 text-green-600" strokeWidth={2} />
                        Phone Number *
                      </Label>
                      <input
                        id="vendor-phone"
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="vendor-confirm-password" className="text-gray-900 dark:text-white flex items-center gap-2 text-base font-semibold">
                        <LockIcon className="w-4 h-4 text-green-600" strokeWidth={2} />
                        Confirm Password *
                      </Label>
                      <input
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="vendor-type" className="text-gray-900 dark:text-white flex items-center gap-2 text-base font-semibold">
                      <BuildingIcon className="w-4 h-4 text-green-600" strokeWidth={2} />
                      Business Type *
                    </Label>
                    <select
                      ...
                      className="w-full px-4 py-3 bg-white dark:bg-gray-800 border-2 border-gray-300 dark:border-gray-600 rounded-xl text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all"
                    >
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="vendor-address" className="text-gray-900 dark:text-white flex items-center gap-2 text-base font-semibold">
                      <MapPinIcon className="w-4 h-4 text-green-600" strokeWidth={2} />
                      Business Address *
                    </Label>
                    <input
                      id="vendor-address"
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="vendor-description" className="text-gray-900 dark:text-white flex items-center gap-2 text-base font-semibold">
                      <FileTextIcon className="w-4 h-4 text-green-600" strokeWidth={2} />
                      Short Description *
                    </Label>
                    <textarea
                      ...
                      rows={3}
                      required
                      className="w-full px-4 py-3 bg-white dark:bg-gray-800 border-2 border-gray-300 dark:border-gray-600 rounded-xl text-gray-900 dark:text-white placeholder:text-gray-500 dark:placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all resize-none"
                    />
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="border-2 border-dashed border-gray-400 dark:border-gray-600 rounded-xl p-6 text-center bg-gray-50 dark:bg-gray-800/50 hover:border-green-500 transition-colors">
                      <input
                      ...
                      {businessLicense ? (
                        <div className="space-y-3">
                          ...
                          <p className="text-gray-900 dark:text-white font-semibold text-sm">{businessLicense.name}</p>
                          <Button
                            type="button"
                        ...
                        <div className="space-y-3">
                          <div className="w-12 h-12 bg-green-100 dark:bg-green-900 rounded-full flex items-center justify-center mx-auto">
                            <UploadIcon className="w-6 h-6 text-green-600 dark:text-green-400" strokeWidth={2} />
                          </div>
                          <p className="text-gray-900 dark:text-white font-semibold text-sm">Upload License</p>
                          <Button
                            type="button"
                            onClick={() => document.getElementById('business-license-upload')?.click()}
                            size="sm"
                            className="bg-gradient-to-r from-green-600 to-teal-600 text-white hover:from-green-700 hover:to-teal-700 rounded-xl"
                          >
                            <UploadIcon className="w-4 h-4 mr-2" strokeWidth={2} />
                            Select File
                          </Button>
                  ...
                  <div className="space-y-2">
                    <Label className="text-gray-900 dark:text-white flex items-center gap-2 text-base font-semibold">
                      <ImageIcon className="w-4 h-4 text-green-600" strokeWidth={2} />
                    ...
                    <div className="border-2 border-dashed border-gray-400 dark:border-gray-600 rounded-xl p-6 text-center bg-gray-50 dark:bg-gray-800/50 hover:border-green-500 transition-colors">
                      ...
                      {logoPreview ? (
                        <div className="space-y-3">
                          <img src={logoPreview} alt="Logo preview" className="w-24 h-24 object-cover rounded-xl mx-auto border-2 border-green-500" />
                          <p className="text-gray-900 dark:text-white font-semibold text-sm">{businessLogo?.name}</p>
                          <Button
                            type="button"
                        ...
                        <div className="space-y-3">
                          <div className="w-12 h-12 bg-green-100 dark:bg-green-900 rounded-full flex items-center justify-center mx-auto">
                            <ImageIcon className="w-6 h-6 text-green-600 dark:text-green-400" strokeWidth={2} />
                          </div>
                          <p className="text-gray-900 dark:text-white font-semibold text-sm">Upload Logo</p>
                          <Button
                            type="button"
                            onClick={() => document.getElementById('business-logo-upload')?.click()}
                            size="sm"
                  ...
                  <div className="flex items-start gap-3 p-4 bg-gray-50 dark:bg-gray-800/50 rounded-xl border-2 border-gray-300 dark:border-gray-600">
                    <input
                      ...
                      onChange={(e) => setVendorData({ ...vendorData, agreeToTerms: e.target.checked })}
                      className="w-5 h-5 mt-0.5 rounded border-gray-300 text-green-600 focus:ring-green-500"
                    />
                    <label htmlFor="vendor-terms" className="text-sm text-gray-700 dark:text-gray-300 cursor-pointer">
                      I agree to the <button type="button" className="text-green-600 hover:text-green-700 dark:text-green-400 font-semibold">Vendor Terms & Conditions</button> and <button type="button" className="text-green-600 hover:text-green-700 dark:text-green-400 font-semibold">Privacy Policy</button>
                    </label>
                  </div>

                  <Button
                    type="submit"
                    disabled={loading || !vendorData.agreeToTerms}
